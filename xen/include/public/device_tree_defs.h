...
#define GUEST_PHANDLE_VPL011_CLK (GUEST_PHANDLE_IOMMU + 1)
#define GUEST_PHANDLE_VSMMUV3 (GUEST_PHANDLE_VPL011_CLK + 1)
#define GUEST_PHANDLE_ITS (GUEST_PHANDLE_VSMMUV3 + 1)
