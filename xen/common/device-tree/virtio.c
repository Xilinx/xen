...
int __init dom_construct_virtio(struct kernel_info *bd)
{
...
static int __init parse_vmp(struct dt_device_node *np, struct kernel_info *bd)
{
...
int __init parse_virtio(const struct dt_device_node *node,
                        struct kernel_info *bd)
{
