...
#define X86_EMU_HPET     (IS_ENABLED(CONFIG_VHPET) ? XEN_X86_EMU_HPET : 0)
#define X86_EMU_PM       XEN_X86_EMU_PM
#define X86_EMU_RTC      (IS_ENABLED(CONFIG_VRTC) ? XEN_X86_EMU_RTC : 0)
#define X86_EMU_IOAPIC   XEN_X86_EMU_IOAPIC
#define X86_EMU_PIC      (IS_ENABLED(CONFIG_VPIC) ? XEN_X86_EMU_PIC : 0)
#define X86_EMU_VGA      (IS_ENABLED(CONFIG_VVGA) ? XEN_X86_EMU_VGA : 0)
...
#define X86_EMU_PIT      (IS_ENABLED(CONFIG_VPIT) ? XEN_X86_EMU_PIT : 0)
