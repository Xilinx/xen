...
static const struct pm_access pm_rst_access[] = {
    ...
    [PM_NODE_IDX(VERSAL_PM_RST_PL0)] = { MM_DEV_PLD_0 },
    [PM_NODE_IDX(VERSAL_PM_RST_PL1)] = { MM_DEV_PLD_0 },
    [PM_NODE_IDX(VERSAL_PM_RST_PL2)] = { MM_DEV_PLD_0 },
    [PM_NODE_IDX(VERSAL_PM_RST_PL3)] = { MM_DEV_PLD_0 },
    ...
    [PM_NODE_IDX(VERSAL_PM_RST_RPU_ISLAND)] = { MM_DEV_RPU0_0 },
    [PM_NODE_IDX(VERSAL_PM_RST_RPU_AMBA)] = { MM_DEV_RPU0_0 },
    [PM_NODE_IDX(VERSAL_PM_RST_R5_0)] = { MM_DEV_RPU0_0 },
    [PM_NODE_IDX(VERSAL_PM_RST_R5_1)] = { MM_DEV_RPU0_1 },
    ...
    [PM_NODE_IDX(VERSAL_PM_RST_OCM)] = { MM_DEV_OCM_0 },
    ...
    [PM_NODE_IDX(VERSAL_PM_RST_SWDT_FPD)] = { MM_DEV_SWDT_FPD },
    [PM_NODE_IDX(VERSAL_PM_RST_SWDT_LPD)] = { MM_DEV_SWDT_LPD },

    [PM_NODE_IDX(VERSAL_PM_RST_USB)] = { MM_DEV_USB_0 },
