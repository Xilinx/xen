...
static const struct pm_clk2node pm_clk_node_map[] = {
    ...
    PM_CLK2NODE(PM_NODE_IDX(PM_CLK_CPU_R5_CORE), PM_NODE_IDX(PM_DEV_RPU0_0)),
    PM_CLK2NODE(PM_NODE_IDX(PM_CLK_CPU_R5_CORE), PM_NODE_IDX(PM_DEV_RPU0_1)),
    PM_CLK2NODE(PM_NODE_IDX(PM_CLK_CPU_R5_OCM), PM_NODE_IDX(PM_DEV_OCM_0)),
    PM_CLK2NODE(PM_NODE_IDX(PM_CLK_CPU_R5_OCM), PM_NODE_IDX(PM_DEV_OCM_1)),
    PM_CLK2NODE(PM_NODE_IDX(PM_CLK_CPU_R5_OCM), PM_NODE_IDX(PM_DEV_OCM_2)),
    PM_CLK2NODE(PM_NODE_IDX(PM_CLK_CPU_R5_OCM), PM_NODE_IDX(PM_DEV_OCM_3)),
...
#define PM_CLK_END_IDX  PM_NODE_IDX(PM_CLK_XRAM_APB)
