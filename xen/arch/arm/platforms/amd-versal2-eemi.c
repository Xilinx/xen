...
/*
 * xen/arch/arm/platforms/amd-versal2-eemi.c
 *
 * AMD Versal2 EEMI API mediator.
 *
...
#include <asm/platforms/amd-versal2-mm.h>
...
static const struct pm_access pm_node_access[] = {
    ...
    [PM_NODE_IDX(VERSAL2_PM_DEV_I2C_2)] = { MM_DEV_I2C_2 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_I2C_3)] = { MM_DEV_I2C_3 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_I2C_4)] = { MM_DEV_I2C_4 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_I2C_5)] = { MM_DEV_I2C_5 },
    ...
    [PM_NODE_IDX(VERSAL2_PM_DEV_CAN_FD_3)] = { MM_DEV_CAN_FD_3 },
    ...
    [PM_NODE_IDX(VERSAL2_PM_DEV_TTC_4)] = { MM_DEV_TTC_4 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TTC_5)] = { MM_DEV_TTC_5 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TTC_6)] = { MM_DEV_TTC_6 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TTC_7)] = { MM_DEV_TTC_7 },

    /* Versal2 WDT nodes. */
    [PM_NODE_IDX(VERSAL_NET_PM_DEV_LPD_SWDT_0)] = { MM_DEV_SWDT_LPD_0 },
    [PM_NODE_IDX(VERSAL_NET_PM_DEV_LPD_SWDT_1)] = { MM_DEV_SWDT_LPD_1 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_LPD_SWDT_2)] = { MM_DEV_SWDT_LPD_2 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_LPD_SWDT_3)] = { MM_DEV_SWDT_LPD_3 },
    [PM_NODE_IDX(VERSAL2_PM_DEV_LPD_SWDT_4)] = { MM_DEV_SWDT_LPD_4 },
    ...
    [PM_NODE_IDX(VERSAL2_PM_DEV_RPU_C_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_RPU_C_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_RPU_D_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_RPU_D_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_RPU_E_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_RPU_E_1)] = { .hwdom_access = true },
    ...
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_2_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_2_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_2_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_2_3)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_3_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_3_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_3_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_OCM_3_3)] = { .hwdom_access = true },
    ...
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_C_0A)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_C_0B)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_C_0C)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_C_1A)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_C_1B)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_C_1C)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_D_0A)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_D_0B)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_D_0C)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_D_1A)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_D_1B)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_D_1C)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_E_0A)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_E_0B)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_E_0C)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_E_1A)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_E_1B)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_DEV_TCM_E_1C)] = { .hwdom_access = true },
    ...
    [PM_NODE_IDX(VERSAL2_PM_DEV_ASU)] = { .hwdom_access = true },
...
static const struct pm_access pm_rst_access[] = {
    ...
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_4)] = { MM_DEV_TTC_4 },
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_5)] = { MM_DEV_TTC_5 },
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_6)] = { MM_DEV_TTC_6 },
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_7)] = { MM_DEV_TTC_7 },
    ...
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_GD_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE0C)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE0C_POR)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_GD_0_TOP)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE1C)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_C_TOPRESET)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE1C_POR)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE0D)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE0D_POR)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_GD_1_TOP)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE1D)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_D_TOPRESET)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE1D_POR)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE0E)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE0E_POR)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE1E)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_E_TOPRESET)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_RPU_CORE1E_POR)] = { .hwdom_access = true },
    ...
    [PM_NODE_IDX(VERSAL2_PM_RST_OCM_3)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_OCM_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_OCM_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_OCM_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ASU_GD_TOP)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ASU_GD)] = { .hwdom_access = true },

    [PM_NODE_IDX(VERSAL2_PM_RST_SWDT_4)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_SWDT_3)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_SWDT_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_UFS)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_CAN_FD_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_CAN_FD_3)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_I3C_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_I3C_3)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_I3C_4)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_I3C_5)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_I3C_6)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_I3C_7)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_4)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_5)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_6)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_TTC_7)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ASU_MB_SOFT)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_UDH_DRD)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_DC)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_GPU)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_GPU_RECOV)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_UDH_AUX)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_UDH_DP)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_UDH_HDCPRAM)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_MMI_GEM)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_MMI_GEM_CFG)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_MMI_GEM_TSU)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_CAN_FD_4)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_CAN_FD_5)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_EIO_UART_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_EIO_UART_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_EIO_UART_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_EIO_SPI_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_EIO_SPI_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_EIO_SPI_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_EIO_SPI_3)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_GPIO_EIO)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_0)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_1)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_2)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_3)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_4)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_5)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_6)] = { .hwdom_access = true },
    [PM_NODE_IDX(VERSAL2_PM_RST_ADMA_7)] = { .hwdom_access = true },

    [PM_NODE_IDX(VERSAL_PM_RST_AIE_ARRAY)] = { MM_DEV_AIE },
    [PM_NODE_IDX(VERSAL_PM_RST_AIE_SHIM)] = { MM_DEV_AIE },
};
...
static const struct pm_clk2node pm_clk_node_map[] = {
    ...
    PM_CLK2NODE(PM_NODE_IDX(VERSAL2_PM_CLK_TTC4), PM_NODE_IDX(VERSAL2_PM_DEV_TTC_4)),
    PM_CLK2NODE(PM_NODE_IDX(VERSAL2_PM_CLK_TTC5), PM_NODE_IDX(VERSAL2_PM_DEV_TTC_5)),
    PM_CLK2NODE(PM_NODE_IDX(VERSAL2_PM_CLK_TTC6), PM_NODE_IDX(VERSAL2_PM_DEV_TTC_6)),
    PM_CLK2NODE(PM_NODE_IDX(VERSAL2_PM_CLK_TTC7), PM_NODE_IDX(VERSAL2_PM_DEV_TTC_7)),
    ...
    PM_CLK2NODE(PM_NODE_IDX(VERSAL2_PM_CLK_CAN2_REF_2X), PM_NODE_IDX(VERSAL2_PM_DEV_CAN_FD_2)),
    PM_CLK2NODE(PM_NODE_IDX(VERSAL2_PM_CLK_CAN3_REF_2X), PM_NODE_IDX(VERSAL2_PM_DEV_CAN_FD_3)),
